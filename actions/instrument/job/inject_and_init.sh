...
processors:
  ...
  transform:
    error_mode: ignore
    log_statements:
      - replace_all_patterns(log.attributes, "value", "[A-Za-z0-9_-]{2,}(?:\.[A-Za-z0-9_-]{2,}){2}", "***")
...
$(printf '%s' "$mask_patterns" | xargs -d '\n' -I '{}' printf '%s\n' '      - replace_all_patterns(log.attributes, "value", "{}", "***")')
      - replace_pattern(log.body, "[A-Za-z0-9_-]{2,}(?:\.[A-Za-z0-9_-]{2,}){2}", "***")
...
$(printf '%s' "$mask_patterns" | xargs -d '\n' -I '{}' printf '%s\n' '      - replace_pattern(log.body, "{}", "***")')
    metric_statements:
      - replace_all_patterns(datapoint.attributes, "value", "[A-Za-z0-9_-]{2,}(?:\.[A-Za-z0-9_-]{2,}){2}", "***")
...
$(printf '%s' "$mask_patterns" | xargs -d '\n' -I '{}' printf '%s\n' '      - replace_all_patterns(datapoint.attributes, "value", "{}", "***")')
    trace_statements:
      - replace_all_patterns(span.attributes, "value", "[A-Za-z0-9_-]{2,}(?:\.[A-Za-z0-9_-]{2,}){2}", "***")
...
$(printf '%s' "$mask_patterns" | xargs -d '\n' -I '{}' printf '%s\n' '      - replace_all_patterns(span.attributes, "value", "{}", "***")')
      - replace_pattern(span.name, "[A-Za-z0-9_-]{2,}(?:\.[A-Za-z0-9_-]{2,}){2}", "***")
