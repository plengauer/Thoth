...
# resolve job id for proper linking
...
if [ "$GITHUB_JOB" = copilot-setup-steps ] && [ "$(echo "$GITHUB_WORKFLOW_REF" | cut -d '@' -f 1 | cut -d / 3-)" = .github/workflows/copilot-setup-steps.yml ]; then
