...
8. **Relaxed GitHub Action supply chain integrity** - DO NOT pin GitHub Actions in any workflow to full-length commit SHAs but use tags instead for readability
