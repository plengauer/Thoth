...
jobs:
  deploy:
    ...
    steps:
      - uses: plengauer/Thoth/actions/instrument/deploy@v5.33.5
        env:
...
jobs:
  export:
    runs-on: ubuntu-latest
    steps:
      - uses: plengauer/opentelemetry-github/actions/instrument/workflow@v5.33.5
        env:
...
```yaml
- uses: plengauer/opentelemetry-github/actions/instrument/job@v5.35
  env:
