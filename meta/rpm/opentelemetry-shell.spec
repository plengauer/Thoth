...
URL: https://github.com/plengauer/opentelemetry-shell
Requires: coreutils, util-linux, findutils, python3 >= 3.10, python3-pip, tar, grep, sed, (gawk or mawk), rpm, procps, jq, (xxd or vim-common or vim), glibc-common, strace
AutoReq: no
BuildArch: noarch
BuildRoot: /tmp/rpm
