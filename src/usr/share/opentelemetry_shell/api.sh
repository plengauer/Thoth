...
if ! ( : 2> "$_otel_remote_sdk_stdout_redirect" ) 2> /dev/null; then _otel_remote_sdk_stdout_redirect=/dev/null; fi
if ! ( : 2> "$_otel_remote_sdk_stderr_redirect" ) 2> /dev/null; then _otel_remote_sdk_stderr_redirect=/dev/null; fi
