...
import { assertUnreachable, isNonEmptyArray, isNumber, isObject, isString } from "./typeUtils.js";
...
function formatPromptTemplate(run) {
    ...
    return {
        ...
        [SemanticConventions.PROMPT_TEMPLATE_TEMPLATE]: safelyGetTemplateFromSerialized(run.serialized) ?? undefined,
    };
}
