...
const main = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const getWeather = (0, langchain_1.tool)(({ city }) => {
    ...
    const calculateMath = (0, langchain_1.tool)(({ expression }) => {
        try {
    ...
    const searchInfo = (0, langchain_1.tool)(({ query }) => {
        // Simulate a knowledge base search
        const knowledgeBase = {
            langchain: "LangChain is a framework for developing applications powered by language models. It provides tools for building agents, chains, and more.",
            openai: "OpenAI is an AI research company that created GPT models and provides API access to various language models.",
            javascript: "JavaScript is a programming language commonly used for web development, both frontend and backend applications.",
            typescript: "TypeScript is a strongly typed programming language that builds on JavaScript by adding static type definitions.",
