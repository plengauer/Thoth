...
import { safelyFlattenAttributes, safelyFormatFunctionCalls, safelyFormatInputMessages, safelyFormatIO, safelyFormatLLMParams, safelyFormatMetadata, safelyFormatOutputMessages, safelyFormatPromptTemplate, safelyFormatRetrievalDocuments, safelyFormatSessionId, safelyFormatTokenCounts, safelyFormatToolCalls, safelyGetOpenInferenceSpanKindFromRunType, } from "./utils.js";
export class LangChainTracer extends BaseTracer {
    ...
    async startTracing(run) {
        ...
        const span = this.tracer.startSpan(run.name, {
            ...
            attributes: {
                [SemanticConventions.OPENINFERENCE_SPAN_KIND]: safelyGetOpenInferenceSpanKindFromRunType(run.run_type) ?? undefined,
            },
        }, activeContext);
