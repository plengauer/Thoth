...
import { addTracerToHandlers } from "./instrumentationUtils.js";
...
export class LangChainInstrumentation extends InstrumentationBase {
    ...
    init() {
        const module = new InstrumentationNodeModuleDefinition("@langchain/core/dist/callbacks/manager.cjs", ["^1.0.0", "^0.3.0", "^0.2.0"], // Only the latest is tested in this module
    ...
    patch(module, moduleVersion) {
        diag.debug(`Applying patch for ${MODULE_NAME}${moduleVersion != null ? `@${moduleVersion}` : ""}`);
        ...
        if ("_configureSync" in module.CallbackManager) {
            this._wrap(module.CallbackManager, "_configureSync", (original) => {
                return function (...args) {
                    ...
                    const newInheritableHandlers = addTracerToHandlers(instrumentation.oiTracer, inheritableHandlers);
    ...
    unpatch(module, moduleVersion) {
        ...
        diag.debug(`Removing patch for ${MODULE_NAME}${moduleVersion != null ? `@${moduleVersion}` : ""}`);
