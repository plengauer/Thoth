    ...
    switch (item.type) {
        ...
        case "file_search_call": {
            if (!item.results) {
                ...
                attributes[`${prefix}${SemanticConventions.MESSAGE_CONTENT}`] = JSON.stringify(item.results);
            }
            break;
        }
        case "computer_call": {
...
export function getResponsesUsageAttributes(response) {
    if (response.usage) {
        return {
            ...
            [SemanticConventions.LLM_TOKEN_COUNT_PROMPT_DETAILS_CACHE_READ]: response.usage.input_tokens_details?.cached_tokens,
            [SemanticConventions.LLM_TOKEN_COUNT_COMPLETION_DETAILS_REASONING]: response.usage.output_tokens_details?.reasoning_tokens,
