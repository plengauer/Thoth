 ...
 */
export function isPatched(moduleName) {
...
export class MCPInstrumentation extends InstrumentationBase {
    ...
    init() {
        return [
            new InstrumentationNodeModuleDefinition("@modelcontextprotocol/sdk/client/sse.js", [">=1.0.0"], this._patchClientSSEModule.bind(this), this._unpatchClientSSEModule.bind(this)),
            new InstrumentationNodeModuleDefinition("@modelcontextprotocol/sdk/server/sse.js", [">=1.0.0"], this._patchServerSSEModule.bind(this), this._unpatchServerSSEModule.bind(this)),
            new InstrumentationNodeModuleDefinition("@modelcontextprotocol/sdk/client/stdio.js", [">=1.0.0"], this._patchClientStdioModule.bind(this), this._unpatchClientStdioModule.bind(this)),
            new InstrumentationNodeModuleDefinition("@modelcontextprotocol/sdk/server/stdio.js", [">=1.0.0"], this._patchServerStdioModule.bind(this), this._unpatchServerStdioModule.bind(this)),
            new InstrumentationNodeModuleDefinition("@modelcontextprotocol/sdk/client/streamableHttp.js", [">=1.10.0"], this._patchClientStreamableHTTPModule.bind(this), this._unpatchClientStreamableHTTPModule.bind(this)),
            new InstrumentationNodeModuleDefinition("@modelcontextprotocol/sdk/server/streamableHttp.js", [">=1.10.0"], this._patchServerStreamableHTTPModule.bind(this), this._unpatchServerStreamableHTTPModule.bind(this)),
        ];
    }
        ...
        return (original) => {
            return function start(...args) {
                ...
                this.onmessage = (...args) => {
                    ...
                    const ctx = propagation.extract(context.active(), (_a = message.params) === null || _a === void 0 ? void 0 : _a._meta);
