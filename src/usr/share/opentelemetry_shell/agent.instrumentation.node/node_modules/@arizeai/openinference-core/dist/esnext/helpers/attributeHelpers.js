import { INPUT_MIME_TYPE, INPUT_VALUE, MimeType, OUTPUT_MIME_TYPE, OUTPUT_VALUE, SemanticConventions, } from "@arizeai/openinference-semantic-conventions";
 ...
 * ```
 */
export function toInputType(...args) {
    var _a;
    if (args.length === 0) {
        return;
    }
    if (args.length === 1) {
        ...
        return {
            value: (_a = safelyJSONStringify(value)) !== null && _a !== void 0 ? _a : "{}",
 ...
 * ```
 */
export function toOutputType(result) {
    var _a;
    if (result == null) {
        return;
    }
    ...
    return {
        value: (_a = safelyJSONStringify(result)) !== null && _a !== void 0 ? _a : "{}",
        mimeType: MimeType.JSON,
    };
}
/**
 ...
 * ```
 */
export const defaultProcessInput = (...args) => getInputAttributes(toInputType(...args));
/**
 ...
 * ```
 */
export const defaultProcessOutput = (res) => getOutputAttributes(toOutputType(res));
/**
 ...
 * ```
 */
export function getOutputAttributes(output) {
    if (output == null) {
        return {};
    }
    ...
    if (Array.isArray(embeddings)) {
        embeddings.forEach((embedding, index) => {
            if (embedding.text != null) {
                attributes[`${SemanticConventions.EMBEDDING_EMBEDDINGS}.${index}.${SemanticConventions.EMBEDDING_TEXT}`] = embedding.text;
            }
            if (embedding.vector != null) {
                attributes[`${SemanticConventions.EMBEDDING_EMBEDDINGS}.${index}.${SemanticConventions.EMBEDDING_VECTOR}`] = embedding.vector;
            }
        });
    }
    return attributes;
...
export function getRetrieverAttributes(options) {
    ...
    documents.forEach((document, index) => {
        ...
        if (document.content != null) {
            attributes[`${SemanticConventions.RETRIEVAL_DOCUMENTS}.${index}.${SemanticConventions.DOCUMENT_CONTENT}`] = document.content;
        }
        if (document.id != null) {
            attributes[`${SemanticConventions.RETRIEVAL_DOCUMENTS}.${index}.${SemanticConventions.DOCUMENT_ID}`] = document.id;
        }
        if (document.metadata != null) {
            ...
            if (typeof document.metadata === "string") {
                ...
                attributes[key] = (_a = safelyJSONStringify(document.metadata)) !== null && _a !== void 0 ? _a : "{}";
            }
        }
        if (document.score != null) {
            attributes[`${SemanticConventions.RETRIEVAL_DOCUMENTS}.${index}.${SemanticConventions.DOCUMENT_SCORE}`] = document.score;
        }
    });
    return attributes;
}
 ...
 * ```
 */
export function getDocumentAttributes(document, documentIndex, keyPrefix) {
    var _a;
    const attributes = {};
    if (document.content != null) {
 ...
 * ```
 */
export function getMetadataAttributes(metadata) {
    var _a;
    return {
        [SemanticConventions.METADATA]: (_a = safelyJSONStringify(metadata)) !== null && _a !== void 0 ? _a : "{}",
    };
}
/**
...
export function getToolAttributes(options) {
    ...
    attributes[SemanticConventions.TOOL_PARAMETERS] = (_a = safelyJSONStringify(parameters)) !== null && _a !== void 0 ? _a : "{}";
    return attributes;
}
/**
...
export function getLLMAttributes(options) {
    ...
    if (options.invocationParameters != null) {
        attributes[SemanticConventions.LLM_INVOCATION_PARAMETERS] =
            (_a = safelyJSONStringify(options.invocationParameters)) !== null && _a !== void 0 ? _a : "{}";
    }
    // Input messages
    if (Array.isArray(options.inputMessages)) {
        options.inputMessages.forEach((message, messageIndex) => {
            if (message.role != null) {
                attributes[`${SemanticConventions.LLM_INPUT_MESSAGES}.${messageIndex}.${SemanticConventions.MESSAGE_ROLE}`] = message.role;
            }
            if (message.content != null) {
                attributes[`${SemanticConventions.LLM_INPUT_MESSAGES}.${messageIndex}.${SemanticConventions.MESSAGE_CONTENT}`] = message.content;
            }
            if (Array.isArray(message.contents)) {
                message.contents.forEach((content, contentIndex) => {
                    var _a;
                    if (content.type != null) {
                        attributes[`${SemanticConventions.LLM_INPUT_MESSAGES}.${messageIndex}.${SemanticConventions.MESSAGE_CONTENTS}.${contentIndex}.${SemanticConventions.MESSAGE_CONTENT_TYPE}`] = content.type;
                    }
                    if (content.type === "text" && content.text != null) {
                        attributes[`${SemanticConventions.LLM_INPUT_MESSAGES}.${messageIndex}.${SemanticConventions.MESSAGE_CONTENTS}.${contentIndex}.${SemanticConventions.MESSAGE_CONTENT_TEXT}`] = content.text;
                    }
                    if (content.type === "image" && ((_a = content.image) === null || _a === void 0 ? void 0 : _a.url) != null) {
                        attributes[`${SemanticConventions.LLM_INPUT_MESSAGES}.${messageIndex}.${SemanticConventions.MESSAGE_CONTENTS}.${contentIndex}.${SemanticConventions.MESSAGE_CONTENT_IMAGE}.${SemanticConventions.IMAGE_URL}`] = content.image.url;
                    }
                    if (content.type === "reasoning") {
                        ...
                        if (content.signature != null) {
                            attributes[`${SemanticConventions.LLM_INPUT_MESSAGES}.${messageIndex}.${SemanticConventions.MESSAGE_CONTENTS}.${contentIndex}.${SemanticConventions.MESSAGE_CONTENT_SIGNATURE}`] = content.signature;
                        }
                        if (content.data != null) {
                            attributes[`${SemanticConventions.LLM_INPUT_MESSAGES}.${messageIndex}.${SemanticConventions.MESSAGE_CONTENTS}.${contentIndex}.${SemanticConventions.MESSAGE_CONTENT_DATA}`] = content.data;
                        }
                        if (content.encryptedContent != null) {
                            attributes[`${SemanticConventions.LLM_INPUT_MESSAGES}.${messageIndex}.${SemanticConventions.MESSAGE_CONTENTS}.${contentIndex}.${SemanticConventions.MESSAGE_CONTENT_ENCRYPTED_CONTENT}`] = content.encryptedContent;
                        }
                    }
                });
            }
            if (message.toolCallId != null) {
                attributes[`${SemanticConventions.LLM_INPUT_MESSAGES}.${messageIndex}.${SemanticConventions.MESSAGE_TOOL_CALL_ID}`] = message.toolCallId;
            }
            if (Array.isArray(message.toolCalls)) {
                message.toolCalls.forEach((toolCall, toolCallIndex) => {
                    var _a, _b, _c;
                    if (toolCall.id != null) {
                        attributes[`${SemanticConventions.LLM_INPUT_MESSAGES}.${messageIndex}.${SemanticConventions.MESSAGE_TOOL_CALLS}.${toolCallIndex}.${SemanticConventions.TOOL_CALL_ID}`] = toolCall.id;
                    }
                    if (((_a = toolCall.function) === null || _a === void 0 ? void 0 : _a.name) != null) {
                        attributes[`${SemanticConventions.LLM_INPUT_MESSAGES}.${messageIndex}.${SemanticConventions.MESSAGE_TOOL_CALLS}.${toolCallIndex}.${SemanticConventions.TOOL_CALL_FUNCTION_NAME}`] = toolCall.function.name;
                    }
                    if (((_b = toolCall.function) === null || _b === void 0 ? void 0 : _b.arguments) != null) {
                        const argsJson = typeof toolCall.function.arguments === "string"
                            ...
                            : ((_c = safelyJSONStringify(toolCall.function.arguments)) !== null && _c !== void 0 ? _c : "{}");
                        attributes[`${SemanticConventions.LLM_INPUT_MESSAGES}.${messageIndex}.${SemanticConventions.MESSAGE_TOOL_CALLS}.${toolCallIndex}.${SemanticConventions.TOOL_CALL_FUNCTION_ARGUMENTS_JSON}`] = argsJson;
                    }
                    if (toolCall.reasoningSignature != null) {
                        attributes[`${SemanticConventions.LLM_INPUT_MESSAGES}.${messageIndex}.${SemanticConventions.MESSAGE_TOOL_CALLS}.${toolCallIndex}.${SemanticConventions.TOOL_CALL_REASONING_SIGNATURE}`] = toolCall.reasoningSignature;
                    }
                });
            }
        });
    ...
    if (Array.isArray(options.outputMessages)) {
        options.outputMessages.forEach((message, messageIndex) => {
            if (message.role != null) {
                attributes[`${SemanticConventions.LLM_OUTPUT_MESSAGES}.${messageIndex}.${SemanticConventions.MESSAGE_ROLE}`] = message.role;
            }
            if (message.content != null) {
                attributes[`${SemanticConventions.LLM_OUTPUT_MESSAGES}.${messageIndex}.${SemanticConventions.MESSAGE_CONTENT}`] = message.content;
            }
            if (Array.isArray(message.contents)) {
                message.contents.forEach((content, contentIndex) => {
                    var _a;
                    if (content.type != null) {
                        attributes[`${SemanticConventions.LLM_OUTPUT_MESSAGES}.${messageIndex}.${SemanticConventions.MESSAGE_CONTENTS}.${contentIndex}.${SemanticConventions.MESSAGE_CONTENT_TYPE}`] = content.type;
                    }
                    if (content.type === "text" && content.text != null) {
                        attributes[`${SemanticConventions.LLM_OUTPUT_MESSAGES}.${messageIndex}.${SemanticConventions.MESSAGE_CONTENTS}.${contentIndex}.${SemanticConventions.MESSAGE_CONTENT_TEXT}`] = content.text;
                    }
                    if (content.type === "image" && ((_a = content.image) === null || _a === void 0 ? void 0 : _a.url) != null) {
                        attributes[`${SemanticConventions.LLM_OUTPUT_MESSAGES}.${messageIndex}.${SemanticConventions.MESSAGE_CONTENTS}.${contentIndex}.${SemanticConventions.MESSAGE_CONTENT_IMAGE}.${SemanticConventions.IMAGE_URL}`] = content.image.url;
                    }
                    if (content.type === "reasoning") {
                        if (content.text != null) {
                            attributes[`${SemanticConventions.LLM_OUTPUT_MESSAGES}.${messageIndex}.${SemanticConventions.MESSAGE_CONTENTS}.${contentIndex}.${SemanticConventions.MESSAGE_CONTENT_TEXT}`] = content.text;
                        ...
                        if (content.signature != null) {
                            attributes[`${SemanticConventions.LLM_OUTPUT_MESSAGES}.${messageIndex}.${SemanticConventions.MESSAGE_CONTENTS}.${contentIndex}.${SemanticConventions.MESSAGE_CONTENT_SIGNATURE}`] = content.signature;
                        }
                        if (content.data != null) {
                            attributes[`${SemanticConventions.LLM_OUTPUT_MESSAGES}.${messageIndex}.${SemanticConventions.MESSAGE_CONTENTS}.${contentIndex}.${SemanticConventions.MESSAGE_CONTENT_DATA}`] = content.data;
                        }
                        if (content.encryptedContent != null) {
                            attributes[`${SemanticConventions.LLM_OUTPUT_MESSAGES}.${messageIndex}.${SemanticConventions.MESSAGE_CONTENTS}.${contentIndex}.${SemanticConventions.MESSAGE_CONTENT_ENCRYPTED_CONTENT}`] = content.encryptedContent;
                        }
                    }
                });
            }
            if (message.toolCallId != null) {
                attributes[`${SemanticConventions.LLM_OUTPUT_MESSAGES}.${messageIndex}.${SemanticConventions.MESSAGE_TOOL_CALL_ID}`] = message.toolCallId;
            }
            if (Array.isArray(message.toolCalls)) {
                message.toolCalls.forEach((toolCall, toolCallIndex) => {
                    var _a, _b, _c;
                    if (toolCall.id != null) {
                        attributes[`${SemanticConventions.LLM_OUTPUT_MESSAGES}.${messageIndex}.${SemanticConventions.MESSAGE_TOOL_CALLS}.${toolCallIndex}.${SemanticConventions.TOOL_CALL_ID}`] = toolCall.id;
                    }
                    if (((_a = toolCall.function) === null || _a === void 0 ? void 0 : _a.name) != null) {
                        attributes[`${SemanticConventions.LLM_OUTPUT_MESSAGES}.${messageIndex}.${SemanticConventions.MESSAGE_TOOL_CALLS}.${toolCallIndex}.${SemanticConventions.TOOL_CALL_FUNCTION_NAME}`] = toolCall.function.name;
                    }
                    if (((_b = toolCall.function) === null || _b === void 0 ? void 0 : _b.arguments) != null) {
                        const argsJson = typeof toolCall.function.arguments === "string"
                            ? toolCall.function.arguments
                            : ((_c = safelyJSONStringify(toolCall.function.arguments)) !== null && _c !== void 0 ? _c : "{}");
                        attributes[`${SemanticConventions.LLM_OUTPUT_MESSAGES}.${messageIndex}.${SemanticConventions.MESSAGE_TOOL_CALLS}.${toolCallIndex}.${SemanticConventions.TOOL_CALL_FUNCTION_ARGUMENTS_JSON}`] = argsJson;
                    }
                    if (toolCall.reasoningSignature != null) {
                        attributes[`${SemanticConventions.LLM_OUTPUT_MESSAGES}.${messageIndex}.${SemanticConventions.MESSAGE_TOOL_CALLS}.${toolCallIndex}.${SemanticConventions.TOOL_CALL_REASONING_SIGNATURE}`] = toolCall.reasoningSignature;
                    }
                });
            }
        });
        ...
        options.tools.forEach((tool, toolIndex) => {
            ...
            if (tool.jsonSchema != null) {
                const schemaJson = typeof tool.jsonSchema === "string"
                    ? tool.jsonSchema
                    : ((_a = safelyJSONStringify(tool.jsonSchema)) !== null && _a !== void 0 ? _a : "{}");
                attributes[`${SemanticConventions.LLM_TOOLS}.${toolIndex}.${SemanticConventions.TOOL_JSON_SCHEMA}`] = schemaJson;
            }
        });
    }
    return attributes;
