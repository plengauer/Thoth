 ...
 */
export declare function wrapTracer(tracer: Tracer): OITracer;
/**
 * A helper function to get a tracer for the decorators.
 */
export declare function getTracer(name?: string): OITracer;
//# sourceMappingURL=tracerHelpers.d.ts.map