...
function withSpan(fn, options) {
    ...
    const configuredTracer = _tracer ? (0, tracerHelpers_1.wrapTracer)(_tracer) : undefined;
    ...
    const wrappedFn = function (...args) {
        const tracer = configuredTracer !== null && configuredTracer !== void 0 ? configuredTracer : (0, tracerHelpers_1.getTracer)();
