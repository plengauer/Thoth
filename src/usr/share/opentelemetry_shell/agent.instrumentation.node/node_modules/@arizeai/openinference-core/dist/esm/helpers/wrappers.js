...
export function traceAgent(fn, options) {
    return withSpan(fn, { ...options, kind: OpenInferenceSpanKind.AGENT });
}
/**
...
export function traceTool(fn, options) {
    return withSpan(fn, { ...options, kind: OpenInferenceSpanKind.TOOL });
}
/**
...
export function traceLLM(fn, options) {
    return withSpan(fn, { ...options, kind: OpenInferenceSpanKind.LLM });
}
/**
...
export function traceReranker(fn, options) {
    return withSpan(fn, { ...options, kind: OpenInferenceSpanKind.RERANKER });
}
/**
...
export function tracePrompt(fn, options) {
    return withSpan(fn, { ...options, kind: OpenInferenceSpanKind.PROMPT });
}
