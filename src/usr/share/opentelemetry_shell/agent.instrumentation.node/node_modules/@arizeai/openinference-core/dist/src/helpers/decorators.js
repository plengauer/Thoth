...
function observe(options = {}) {
    return function (originalMethod, ctx) {
        const methodName = String(ctx.name);
        // Create options with method name as fallback for span name
        const traceOptions = Object.assign(Object.assign({}, options), { name: options.name || methodName });
        ...
        const wrappedMethod = function (...args) {
            ...
            const tracedMethod = (0, withSpan_1.withSpan)(boundMethod, traceOptions);
