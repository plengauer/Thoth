...
import type { Metadata, PromptTemplate, Session, Tags, User } from "./types.js";
 ...
 * ```
 */
export declare function setPromptTemplate(context: Context, promptTemplate: PromptTemplate): Context;
/**
 ...
 * ```
 */
export declare function setSession(context: Context, session: Session): Context;
 ...
 * ```
 */
export declare function setMetadata(context: Context, metadata: Metadata): Context;
/**
 ...
 * ```
 */
export declare function setUser(context: Context, user: User): Context;
/**
 ...
 * ```
 */
export declare function setTags(context: Context, tags: Tags): Context;
/**
