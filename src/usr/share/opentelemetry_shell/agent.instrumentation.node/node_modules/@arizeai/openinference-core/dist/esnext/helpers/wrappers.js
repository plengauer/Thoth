 ...
 * ```
 */
export function traceChain(fn, options) {
    return withSpan(fn, Object.assign(Object.assign({}, options), { kind: OpenInferenceSpanKind.CHAIN }));
}
/**
 ...
 * ```
 */
export function traceAgent(fn, options) {
    return withSpan(fn, Object.assign(Object.assign({}, options), { kind: OpenInferenceSpanKind.AGENT }));
}
/**
 ...
 * ```
 */
export function traceTool(fn, options) {
    return withSpan(fn, Object.assign(Object.assign({}, options), { kind: OpenInferenceSpanKind.TOOL }));
}
/**
 ...
 * ```
 */
export function traceLLM(fn, options) {
    return withSpan(fn, Object.assign(Object.assign({}, options), { kind: OpenInferenceSpanKind.LLM }));
}
/**
 ...
 * ```
 */
export function traceRetriever(fn, options) {
    return withSpan(fn, Object.assign(Object.assign({}, options), { kind: OpenInferenceSpanKind.RETRIEVER }));
}
/**
 ...
 * ```
 */
export function traceReranker(fn, options) {
    return withSpan(fn, Object.assign(Object.assign({}, options), { kind: OpenInferenceSpanKind.RERANKER }));
}
/**
 ...
 * ```
 */
export function traceEmbedding(fn, options) {
    return withSpan(fn, Object.assign(Object.assign({}, options), { kind: OpenInferenceSpanKind.EMBEDDING }));
}
/**
 ...
 * ```
 */
export function traceGuardrail(fn, options) {
    return withSpan(fn, Object.assign(Object.assign({}, options), { kind: OpenInferenceSpanKind.GUARDRAIL }));
}
/**
...
export function traceEvaluator(fn, options) {
    return withSpan(fn, Object.assign(Object.assign({}, options), { kind: OpenInferenceSpanKind.EVALUATOR }));
}
/**
 ...
 * ```
 */
export function tracePrompt(fn, options) {
    return withSpan(fn, Object.assign(Object.assign({}, options), { kind: OpenInferenceSpanKind.PROMPT }));
}
