...
exports.traceRetriever = traceRetriever;
exports.traceReranker = traceReranker;
exports.traceEmbedding = traceEmbedding;
exports.traceGuardrail = traceGuardrail;
exports.traceEvaluator = traceEvaluator;
exports.tracePrompt = tracePrompt;
const openinference_semantic_conventions_1 = require("@arizeai/openinference-semantic-conventions");
const withSpan_1 = require("./withSpan");
/**
 ...
 * ```
 */
function traceChain(fn, options) {
    return (0, withSpan_1.withSpan)(fn, Object.assign(Object.assign({}, options), { kind: openinference_semantic_conventions_1.OpenInferenceSpanKind.CHAIN }));
}
/**
 ...
 * ```
 */
function traceAgent(fn, options) {
    return (0, withSpan_1.withSpan)(fn, Object.assign(Object.assign({}, options), { kind: openinference_semantic_conventions_1.OpenInferenceSpanKind.AGENT }));
}
/**
 ...
 * ```
 */
function traceTool(fn, options) {
    return (0, withSpan_1.withSpan)(fn, Object.assign(Object.assign({}, options), { kind: openinference_semantic_conventions_1.OpenInferenceSpanKind.TOOL }));
}
/**
 ...
 * ```
 */
function traceLLM(fn, options) {
    return (0, withSpan_1.withSpan)(fn, Object.assign(Object.assign({}, options), { kind: openinference_semantic_conventions_1.OpenInferenceSpanKind.LLM }));
}
/**
 ...
 * ```
 */
function traceRetriever(fn, options) {
    return (0, withSpan_1.withSpan)(fn, Object.assign(Object.assign({}, options), { kind: openinference_semantic_conventions_1.OpenInferenceSpanKind.RETRIEVER }));
}
/**
 ...
 * ```
 */
function traceReranker(fn, options) {
    return (0, withSpan_1.withSpan)(fn, Object.assign(Object.assign({}, options), { kind: openinference_semantic_conventions_1.OpenInferenceSpanKind.RERANKER }));
}
/**
 ...
 * ```
 */
function traceEmbedding(fn, options) {
    return (0, withSpan_1.withSpan)(fn, Object.assign(Object.assign({}, options), { kind: openinference_semantic_conventions_1.OpenInferenceSpanKind.EMBEDDING }));
}
/**
 ...
 * ```
 */
function traceGuardrail(fn, options) {
    return (0, withSpan_1.withSpan)(fn, Object.assign(Object.assign({}, options), { kind: openinference_semantic_conventions_1.OpenInferenceSpanKind.GUARDRAIL }));
}
/**
 ...
 * ```
 */
function traceEvaluator(fn, options) {
    return (0, withSpan_1.withSpan)(fn, Object.assign(Object.assign({}, options), { kind: openinference_semantic_conventions_1.OpenInferenceSpanKind.EVALUATOR }));
}
/**
 ...
 * ```
 */
function tracePrompt(fn, options) {
    return (0, withSpan_1.withSpan)(fn, Object.assign(Object.assign({}, options), { kind: openinference_semantic_conventions_1.OpenInferenceSpanKind.PROMPT }));
}
