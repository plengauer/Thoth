 ...
 * ```
 */
export function withSpan(fn, options) {
    const { tracer: _tracer, name: optionsName, processInput: _processInput, processOutput: _processOutput, openTelemetrySpanKind = SpanKind.INTERNAL, kind = OpenInferenceSpanKind.CHAIN, attributes: baseAttributes, } = options || {};
    const configuredTracer = _tracer ? wrapTracer(_tracer) : undefined;
    const processInput = _processInput !== null && _processInput !== void 0 ? _processInput : defaultProcessInput;
    const processOutput = _processOutput !== null && _processOutput !== void 0 ? _processOutput : defaultProcessOutput;
    ...
    const wrappedFn = function (...args) {
        const tracer = configuredTracer !== null && configuredTracer !== void 0 ? configuredTracer : getTracer();
