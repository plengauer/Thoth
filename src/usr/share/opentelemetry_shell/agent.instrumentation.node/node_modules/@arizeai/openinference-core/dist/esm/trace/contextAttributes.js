...
import { isAttributes, isObjectWithStringKeys, isStringArray, safelyJSONParse, safelyJSONStringify, } from "../utils/index.js";
 ...
 * ```
 */
export function setPromptTemplate(context, promptTemplate) {
 ...
 * ```
 */
export function setSession(context, session) {
 ...
 * ```
 */
export function setMetadata(context, metadata) {
 ...
 * ```
 */
export function setTags(context, tags) {
