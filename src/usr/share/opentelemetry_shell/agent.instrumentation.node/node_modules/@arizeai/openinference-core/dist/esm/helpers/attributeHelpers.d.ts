...
import type { Document, Embedding, InputToAttributesFn, Message, OutputToAttributesFn, SpanInput, SpanOutput, TokenCount, Tool } from "./types.js";
/**
 ...
 * ```
 */
export declare function toInputType(...args: unknown[]): SpanInput | undefined;
/**
 ...
 * ```
 */
export declare function toOutputType(result: unknown): SpanOutput | undefined;
/**
 ...
 * ```
 */
export declare const defaultProcessInput: InputToAttributesFn;
/**
 ...
 * ```
 */
export declare const defaultProcessOutput: OutputToAttributesFn;
/**
 ...
 * ```
 */
export declare function getOutputAttributes(output: SpanOutput | string | null | undefined): Attributes;
/**
 ...
 * ```
 */
export declare function getInputAttributes(input: SpanInput | string | undefined): Attributes;
/**
 ...
 * ```
 */
export declare function getEmbeddingAttributes(options: {
    modelName?: string;
 ...
 * ```
 */
export declare function getRetrieverAttributes(options: {
    documents: Document[];
}): Attributes;
/**
 ...
 * ```
 */
export declare function getDocumentAttributes(document: Document, documentIndex: number, keyPrefix: string): Attributes;
/**
 ...
 * ```
 */
export declare function getMetadataAttributes(metadata: Record<string, unknown>): Attributes;
/**
 ...
 * ```
 */
export declare function getToolAttributes(options: {
    name: string;
    description?: string;
 ...
 * ```
 */
export declare function getLLMAttributes(options: {
    provider?: string;
    system?: string;
    modelName?: string;
...
//# sourceMappingURL=attributeHelpers.d.ts.map