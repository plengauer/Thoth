 ...
 */
export function isSimpleTextResponse(message) {
 ...
 */
export function formatImageUrl(source) {
 ...
 */
export function extractInvocationParameters(requestBody, system) {
    if (system === LLMSystem.AMAZON &&
    ...
    else if (system === LLMSystem.AMAZON &&
 ...
 */
export function extractToolResultBlocks(content) {
 ...
 */
export function coerceNovaToMessageContent(content) {
 ...
 */
export function convertMetaToMessageContent(responseBody) {
