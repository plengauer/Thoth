...
import { extractInvocationParameters, extractToolResultBlocks, formatImageUrl, normalizeRequestContentBlocks, parseRequestBody, } from "./invoke-model-helpers";
// Helper functions
/**
...
function extractBaseRequestAttributes({ span, command, requestBody, system, }) {
    var _a;
    const modelId = ((_a = command.input) === null || _a === void 0 ? void 0 : _a.modelId) || "unknown";
