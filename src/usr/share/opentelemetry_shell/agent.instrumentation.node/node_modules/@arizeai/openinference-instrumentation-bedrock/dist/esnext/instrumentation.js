...
import { ConverseCommand, ConverseStreamCommand, InvokeModelCommand, InvokeModelWithResponseStreamCommand, } from "@aws-sdk/client-bedrock-runtime";
...
export class BedrockInstrumentation extends InstrumentationBase {
     ...
     */
    init() {
        const module = new InstrumentationNodeModuleDefinition(MODULE_NAME, ["^3.0.0"], this.patch.bind(this), this.unpatch.bind(this));
        return [module];
    }
    get tracer() {
    ...
    handleInvokeModelCommand(args, command, original, client) {
        ...
        const system = getSystemFromModelId(modelId !== null && modelId !== void 0 ? modelId : "");
