 ...
 */
export const LLM_FINISH_REASON = `${SemanticAttributePrefixes.llm}.${LLMAttributePostfixes.finish_reason}`;
/**
 ...
 */
export const TOOL_CALL_REASONING_SIGNATURE = `${SemanticAttributePrefixes.tool_call}.${ToolCallAttributePostfixes.reasoning_signature}`;
/**
 ...
 */
export const MESSAGE_CONTENT_ID = `${SemanticAttributePrefixes.message_content}.${MessageContentsAttributePostfixes.id}`;
/**
 ...
 */
export const MESSAGE_CONTENT_SIGNATURE = `${SemanticAttributePrefixes.message_content}.${MessageContentsAttributePostfixes.signature}`;
/**
 * Opaque vendor-issued data captured verbatim. Maps to Anthropic
 * redacted_thinking.data
 */
export const MESSAGE_CONTENT_DATA = `${SemanticAttributePrefixes.message_content}.${MessageContentsAttributePostfixes.data}`;
/**
 * OpenAI encrypted_content captured verbatim
 */
export const MESSAGE_CONTENT_ENCRYPTED_CONTENT = `${SemanticAttributePrefixes.message_content}.${MessageContentsAttributePostfixes.encrypted_content}`;
/**
 ...
 */
export const TOOL_ID = `${SemanticAttributePrefixes.tool}.${ToolAttributePostfixes.id}`;
/**
