...
_otel_pipe_curl_stderr() {
  ...
  local http_client_request_body_size_handle="$(otel_counter_create histogram http.client.request.body.size 's' '' 'Size of HTTP client request bodies')"
  local http_client_response_body_size_handle="$(otel_counter_create histogram http.client.response.body.size 's' '' 'Size of HTTP client response bodies')"
